...
function () {
   ...
   */
  function JFAProgram(_a) {
    var _this = this;

    var reglInstance = _a.reglInstance,
        _b = _a.canvasWidth,
        width = _b === void 0 ? 500 : _b,
        _c = _a.canvasHeight,
        height = _c === void 0 ? 500 : _c,
        _d = _a.sourceBackground,
        sourceBackground = _d === void 0 ? [0, 0, 0, 0] : _d;
    this.reglInstance = reglInstance;
    this.canvasWidth = width;
    this.canvasHeight = height;
    this.bgColor = sourceBackground;
    var front = this.newFramebuffer(width, height);
    this.frontBuffer = front[0];
    this.frontTexture = front[1];
    var back = this.newFramebuffer(width, height);
    this.backBuffer = back[0];
    this.backTexture = back[1];
    var gl = this.reglInstance;
    ...
    this.vertexSetup = gl({
      ...
      uniforms: {
        t: function t() {
          return Date.now() - startingTime;
        },
        res: function res() {
          return [_this.canvasWidth, _this.canvasHeight];
        },
  ...
  JFAProgram.prototype.runJFA = function () {}; //#endregion
  //#region privateFunctions


  JFAProgram.prototype.newFramebuffer = function (width, height) {
    var _this = this;
    ...
    var tx = gl.texture({
      ...
      width: width,
      wrap: 'clamp',
      data: new Array(width * height * 4).map(function (v, i) {
        return _this.bgColor[i % 4];
      })
    });
...
},{}],"tests.ts":[function(require,module,exports) {
"use strict";
...
var jf = __importStar(require("../src/index"));
...
console.log(b);
var x = new jf.JFAProgram({
  reglInstance: regl_1.default(b),
  sourceBackground: [0.98, 0.97, 0.98, 0.0],
  canvasHeight: b.height,
  canvasWidth: b.width
});
},{"../src/index":"../src/index.ts","regl":"../node_modules/regl/dist/regl.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tests.ts"], null)
//# sourceMappingURL=/tests.2b11a79c.js.map